                          ...
                          data.map((row, ind) => (
                            <tr key={ind}>
                              ...
                              <td>
                                ...
                                <Image onError={(e) => {
                                  e.target.src="https://png.pngtree.com/png-clipart/20220419/ourmid/pngtree-azul-brand-png-png-image_4548281.png"
                              ...
                              <td>
                                <NavLink to={'/admin/brand/'+row._id} className={"btn btn-sm btn-warning rounded-circle me-1"}>
                                ...
                                }} to={'/admin/brand/'+row._id} className={"btn btn-sm btn-danger rounded-circle me-1"}>
